...
public class TransactionableRemote implements Transactionable {
	 ...
	 * transaction context. A node can only be in one transaction at a time.
	 * <p>
	 ...
	 * <p>
	 * This method can only be called in a transaction context, otherwise an IllegalStateException is thrown. The
